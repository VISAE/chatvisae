...
${if:agent}
${if:canpost}
                <td><a href="${page:asignarTemaLink}" target="_blank" title="${msg:chat.window.toolbar.asignarTema}" onClick="this.newWindow = window.open('${page:asignarTemaLink}', 'AsignarTema', 'toolbar=0,scrollbars=0,location=0,statusbar=1,menubar=0,width=603,height=254,resizable=0'); if (this.newWindow != null) {this.newWindow.focus();this.newWindow.opener=window;}return false;">
                <img class="tplimage" src="${mibewroot}/styles/${styleid}/images/buttons/asignar_tema.gif" border="0" alt="${msg:chat.window.toolbar.asignarTema}"/></a></td>
                
                <td><a href="${page:notificarValoracionLink}" target="_blank" title="${msg:chat.window.toolbar.notificarValoracion}" onClick="this.newWindow = window.open('${page:notificarValoracionLink}', 'notificarValoracion', 'toolbar=0,scrollbars=0,location=0,statusbar=1,menubar=0,width=603,height=254,resizable=0'); if (this.newWindow != null) {this.newWindow.focus();this.newWindow.opener=window;}return false;">
                <img class="tplimage" src="${mibewroot}/styles/${styleid}/images/buttons/notificar_valoracion.gif" border="0" alt="${msg:chat.window.toolbar.notificarValoracion}"/></a></td>
...
${endif:sslLink}
			...
			<td align="right" style="padding-right:17px;">
				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0">
					<tr>
					<td width="95" height="13"  align="center" >&nbsp;</td>
					</tr>
					</table>
				</td>
				<td width="5"></td>
				<td>
                ${if:agent}
                <a class="closethread" href="javascript:void(0)" onClick="return false;" title="${msg:chat.window.close_title}"><img class="tplimage iclosewin" src="${mibewroot}/images/free.gif" border="0" alt="${msg:chat.window.close_title}"/></a>
                ${endif:agent}
                </td>
				<td width="5"></td>
				</tr>
...
${endif:canpost}
    ...
    <!-- +++++++++++ INICIO fila para transferencia de ficheros +++++++++++++ -->
	<tr>
    <td width="10">&nbsp;</td>
    <td >
    	<table width="100%">
        <tr>
            <td width="50%">
            ${if:canpost}
                  <iframe src="${mibewroot}/modulo/archivo/form_cargar_archivo.php?thread=${page:ct.chatThreadId}&token=${page:ct.token}${if:agent}&agent=1${endif:agent}" width="100%" height="100" frameborder="0" scrolling="no" style="border:#999 solid 1px; margin-top:5px;"></iframe>
             ${endif:canpost}
            </td>
            <td width="50%">
            	${if:canpost}
                  <iframe src="${mibewroot}/modulo/archivo/listar_archivos.php?thread=${page:ct.chatThreadId}&token=${page:ct.token}${if:agent}&agent=1${endif:agent}" width="100%" height="100" frameborder="0" scrolling="auto" style="border:#999 solid 1px; margin-top:5px;"></iframe>
                ${endif:canpost}
            </td>
        </tr>
        </table>
        ...
        <tr>
            <td width="15%">&nbsp;</td>
            <td width="70%" align="center" class="copyr" id="poweredByTD">${msg:chat.window.poweredby} <a id="poweredByLink" href="http://mibew.org" title="Mibew Community" target="_blank">mibew.org</a></td>
            <td width="15%">&nbsp;</td>
    ...
    <td width="5">&nbsp;</td>
     ...
     <!-- +++++++++++ FIN fila para transferencia de ficheros +++++++++++++ -->
