...
<td>
    ...
    <td width="33%">
	    ...
	    <td style="background-image: url(${mibewroot}/images/submitbg.gif)" valign="top" class="submit">
			...
			<!--<a href="javascript:document.surveyForm.submit();" title="${msg:presurvey.submit}">${msg:presurvey.submit}</a>-->
            <a href="javascript:validar_acceso(document.surveyForm);" title="${msg:presurvey.submit}">${msg:presurvey.submit}</a>
            <br/>
		</td>
