...
${endif:canpost}
        ...
        <td colspan="3">
        			...
        			<table width="100%" bgcolor="#FFFFFF">
                        ...
                        <tr>
                            <td width="15%">&nbsp;</td>
                            <td width="70%" align="center" class="copyr">${msg:chat.window.poweredby} <a id="poweredByLink" href="http://mibew.org" title="Mibew Community" target="_blank">mibew.org</a></td>
                            <td width="15%">&nbsp;</td>
