...
<head>
	...
	<script type="text/javascript">
		...
		function setTrueHeight() {
			...
			${if:user}
				someWidth = chatWidth-28;//someWidth = chatWidth-28-120;
			${else:user}
...
<body class="body">
	...
	<div id="chatheader">
		<div class="bgc"><div class="bgl"><div class="bgr">
			...
			<div class="buttons">
				...
				${if:agent}
					${if:canpost}
						<a href="${page:asignarTemaLink}" target="_blank" title="${msg:chat.window.toolbar.asignarTema}" onClick="this.newWindow = window.open('${page:asignarTemaLink}', 'AsignarTema', 'toolbar=0,scrollbars=0,location=0,statusbar=1,menubar=0,width=603,height=254,resizable=0'); if (this.newWindow != null) {this.newWindow.focus();this.newWindow.opener=window;}return false;">
                        <img class="tplimage" src="${mibewroot}/styles/${styleid}/images/buttons/asignar_tema.gif" border="0" alt="${msg:chat.window.toolbar.asignarTema}"/></a>
                        
                        <a href="${page:notificarValoracionLink}" target="_blank" title="${msg:chat.window.toolbar.notificarValoracion}" onClick="this.newWindow = window.open('${page:notificarValoracionLink}', 'notificarValoracion', 'toolbar=0,scrollbars=0,location=0,statusbar=1,menubar=0,width=603,height=254,resizable=0'); if (this.newWindow != null) {this.newWindow.focus();this.newWindow.opener=window;}return false;">
                        <img class="tplimage" src="${mibewroot}/styles/${styleid}/images/buttons/notificar_valoracion.gif" border="0" alt="${msg:chat.window.toolbar.notificarValoracion}"/></a>
	...
	<div id="chat">
		<div class="bgl"><div class="bgr"><div class="sdwbgc"><div class="sdwbgl"><div class="sdwbgr">
			<iframe onload="setTrueHeight();" id="chatwnd" name="chatwnd" src="${if:neediframesrc}${mibewroot}/images/blank.html${endif:neediframesrc}" frameborder="0" style="overflow:auto; width:100%; min-height:100px;">
    ...
    <tr>
        <td width="50%">
        ${if:canpost}
              <iframe src="${mibewroot}/modulo/archivo/form_cargar_archivo.php?thread=${page:ct.chatThreadId}&token=${page:ct.token}${if:agent}&agent=1${endif:agent}" width="100%" height="120" frameborder="0" scrolling="no" style="border:#999 solid 1px; margin-top:5px;"></iframe>
         ${endif:canpost}
        </td>
        <td width="50%">
            ${if:canpost}
              <iframe src="${mibewroot}/modulo/archivo/listar_archivos.php?thread=${page:ct.chatThreadId}&token=${page:ct.token}${if:agent}&agent=1${endif:agent}" width="100%" height="120" frameborder="0" scrolling="auto" style="border:#999 solid 1px; margin-top:5px;"></iframe>
            ${endif:canpost}
        </td>
    </tr>
    </table>
